...
- [ ] 8. Follow-up to 2a: on phones (390x780 = toolbar visible, de and fa, every era and the Convergence) check at first load whether any text, button or puzzle control sits in the bottom band hidden under the toolbar. If yes, fix it without bringing back the relayout (toolbar.mjs stays green); before/after screenshots.
