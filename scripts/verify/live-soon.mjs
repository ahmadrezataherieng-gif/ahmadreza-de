...
for (const [path, type] of [['/og/ahmadreza-taheri-de.png', 'image/png'], ['/fonts/vazirmatn-arabic-wght.woff2', 'font/woff2'], ['/fonts/LICENSES.md', ''], ['/fonts/licenses/vazirmatn-OFL.txt', 'text/plain']]) {
