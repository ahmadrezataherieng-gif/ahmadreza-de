...
export type AppCopyId = 'about' | 'contact' | 'timeline' | 'terminal' | 'tickets' | 'traceroute' | 'assistant' | 'assistant-journey' | 'quiz' | 'stats' | 'binary' | 'snake' | 'paint' | 'network' | 'time-machine' | 'cv' | 'scheduler' | 'filesystem';
