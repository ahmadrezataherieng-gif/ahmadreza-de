...
| Martian Grotesk | headings of the coming-soon page | Copyright 2021 The Martian Grotesk Project Authors | SIL OFL 1.1 | https://github.com/evilmartians/grotesk, release v1.0.0 (`martian-grotesk-1.0.0-variable.zip`); the zip has no licence file, so `OFL.txt` comes from the same repository | [licenses/martian-grotesk-OFL.txt](licenses/martian-grotesk-OFL.txt) |
| Geist | body text of the coming-soon page | Copyright 2024 The Geist Project Authors | SIL OFL 1.1 | https://github.com/vercel/geist-font (via the `@fontsource-variable/geist` package) | [licenses/geist-OFL.txt](licenses/geist-OFL.txt) |
| Geist Mono | code and technical details of the coming-soon page | Copyright 2024 The Geist Project Authors | SIL OFL 1.1 | https://github.com/vercel/geist-font (via `@fontsource-variable/geist-mono`) | [licenses/geist-mono-OFL.txt](licenses/geist-mono-OFL.txt) |
