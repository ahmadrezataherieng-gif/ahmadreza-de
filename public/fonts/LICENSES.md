...
When a font is added (for example the coming-soon page's fonts, ROADMAP
BR-04), its row and its licence file are added here in the same change;
`scripts/test/fonts.test.mjs` fails otherwise.
