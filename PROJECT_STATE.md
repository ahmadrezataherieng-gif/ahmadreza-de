...
- **The core apps** (Phase 7, DECISIONS.md 50), each its own lazy chunk with its
  ...
  - **Contact** (2026-09-23): e-mail (`mailto:` and a copy button, never a form), résumé, location, profile links once `content/profiles.ts` has URLs, the legal pages. Timeline and CV are still placeholders.
